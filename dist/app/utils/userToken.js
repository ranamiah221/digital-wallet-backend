...
const createUserToken = (user) => {
    ...
    const accessToken = (0, jwt_1.generateToken)(JwtPayload, env_1.envVars.JWT_TOKEN_SECRET, env_1.envVars.JWT_EXPIRE_IN);
    const refreshToken = (0, jwt_1.generateToken)(JwtPayload, env_1.envVars.JWT_REFRESH_TOKEN_SECRET, env_1.envVars.JWT_REFRESH_EXPIRE_IN);
    return {
        accessToken,
        refreshToken
    };
